...
class Storage(Worker):
    ...
    def buildUp(self):
        ...
        self.conn.execute('create table if not exists data (timestamp real primary key, voltage real, used real, charged real, usedkwhs real, chargedkwhs real, kwhs real);')
    ...
    def put(self, row):
        ...
        self.cursor.execute('insert into data (timestamp, voltage, used, charged, usedkwhs, chargedkwhs, kwhs) values (?, ?, ?, ?, ?, ?, ?);',
